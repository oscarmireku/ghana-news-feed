    ...
    try {
        ...
        if (req.query.force === 'true') {
            ...
            try {
                ...
                const scriptPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(projectRoot, 'src', 'scripts', 'scrape-standalone.ts');
        ...
        const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'news-feed.json');
        ...
        res.status(200).json({
            success: true,
            message: 'news-feed.json updated',
            count: stories.length
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2d9b2b6e._.js.map