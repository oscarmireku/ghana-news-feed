...
"[project]/news/src/app/api/cron/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const maxDuration = 60; // Extend timeout for hobby plan (if applicable)
// ---------------------------------------------------------------------------
// Helpers
// ---------------------------------------------------------------------------
...
async function GET(request) {
    ...
    const newArticlesCount = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$news$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["insertArticles"])(storiesWithImages);
    console.log(`CRON: Added ${newArticlesCount} new articles`);
    const deletedInvalid = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$news$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteInvalidArticles"])();
    const deletedOld = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$news$2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteOldArticles"])(500);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8f198cec._.js.map