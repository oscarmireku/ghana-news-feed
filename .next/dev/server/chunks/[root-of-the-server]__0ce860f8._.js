...
"[project]/news/src/pages/api/cron.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$cheerio__$5b$external$5d$__$28$cheerio$2c$__esm_import$2c$__$5b$project$5d2f$news$2f$node_modules$2f$cheerio$29$__ = __turbopack_context__.i("[externals]/cheerio [external] (cheerio, esm_import, [project]/news/node_modules/cheerio)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$externals$5d2f$cheerio__$5b$external$5d$__$28$cheerio$2c$__esm_import$2c$__$5b$project$5d2f$news$2f$node_modules$2f$cheerio$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$news$2f$src$2f$lib$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$externals$5d2f$cheerio__$5b$external$5d$__$28$cheerio$2c$__esm_import$2c$__$5b$project$5d2f$news$2f$node_modules$2f$cheerio$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$news$2f$src$2f$lib$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
const config = {
    maxDuration: 60
...
async function fetchArticleMetadata(link, source) {
    try {
        ...
        const $ = __TURBOPACK__imported__module__$5b$externals$5d2f$cheerio__$5b$external$5d$__$28$cheerio$2c$__esm_import$2c$__$5b$project$5d2f$news$2f$node_modules$2f$cheerio$29$__["load"](html);
        // Image
    ...
    await Promise.all(sections.map(async (sec)=>{
        try {
            ...
            candidates.slice(0, 10).each((_, el)=>{
                ...
                const isUnwantedTitle = unwantedTitlePatterns.some((pattern)=>title.toLowerCase().trim() === pattern.toLowerCase() || title.toLowerCase().includes(pattern.toLowerCase()));
...
async function scrapeAdomOnline() {
    ...
    await Promise.all(feeds.map(async (feed)=>{
        try {
            ...
            const $ = __TURBOPACK__imported__module__$5b$externals$5d2f$cheerio__$5b$external$5d$__$28$cheerio$2c$__esm_import$2c$__$5b$project$5d2f$news$2f$node_modules$2f$cheerio$29$__["load"](xml, {
                xmlMode: true
            });
...
async function scrapePeaceFM() {
    try {
        ...
        const articles = json.data.map((item)=>{
...
const GENERIC_FEEDS = [
    ...
    {
        source: 'Modern Ghana',
        url: 'https://www.modernghana.com/rssfeed/news.xml',
        section: 'News'
    },
    {
        source: 'GNA',
    ...
    },
    {
        ...
        url: 'https://www.graphic.com.gh/news/general-news?format=feed',
        section: 'News'
    },
    {
        source: 'Ghanaian Times',
        url: 'https://www.ghanaiantimes.com.gh/feed/',
        section: 'News'
    },
    {
        source: 'Starr FM',
    ...
    },
    {
        ...
        url: 'https://atinkaonline.com/feed/',
        section: 'News'
    },
    {
        source: 'Asaase Radio',
        url: 'https://asaaseradio.com/feed/',
        section: 'News'
    },
    {
        source: 'The Herald',
        url: 'https://theheraldghana.com/feed/',
        section: 'News'
    },
    {
        source: 'The Chronicle',
        url: 'https://thechronicle.com.gh/feed/',
        section: 'News'
    },
    {
        source: 'GhPage',
        url: 'https://ghpage.com/feed/',
    ...
    {
        source: 'YFM Ghana',
        url: 'https://yfmghana.com/feed/',
        section: 'Entertainment'
    },
    {
        source: 'Happy Ghana',
        url: 'https://www.happyghana.com/feed/',
        section: 'News'
    },
    {
        source: 'GhanaSoccerNet',
        url: 'https://ghanasoccernet.com/feed',
        section: 'Sports'
    }
];
async function scrapeGenericRSS() {
    const stories = [];
    await Promise.all(GENERIC_FEEDS.map(async (feed)=>{
        try {
            ...
            items.slice(0, 5).each((_, el)=>{
                ...
                let image = $(el).find('media\\:content').attr('url')?.trim() || $(el).find('media\\:thumbnail').attr('url')?.trim() || $(el).find('enclosure').attr('url')?.trim();
                if (!image) {
                ...
                let category = '';
                if (isAtom) {
                    category = $(el).find('category').attr('term') || $(el).find('category').attr('label') || '';
                } else {
...
async function handler(req, res) {
    ...
    const storiesWithImages = allStories.filter((story)=>story.image !== null && story.image !== '' && !story.image.toLowerCase().endsWith('.svg'));
    console.log(`CRON: Filtered -> ${storiesWithImages.length} articles to insert`);
    const newArticlesCount = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$news$2f$src$2f$lib$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["insertArticles"])(storiesWithImages);
    console.log(`CRON: Added ${newArticlesCount} new articles`);
    const deletedInvalid = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$news$2f$src$2f$lib$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["deleteInvalidArticles"])();
    const deletedOld = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$news$2f$src$2f$lib$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["deleteOldArticles"])(500);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0ce860f8._.js.map